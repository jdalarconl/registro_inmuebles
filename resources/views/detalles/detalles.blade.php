            ...
            <div class="row grupo seccion">
                ...
                <div class="col-12 col-md-3 border-right">
                    <div class="form-group row">
                        ...
                        <div class="col-6">
                            {!! Form::select('niveles', $niveles, null, ['class' => 'form-select', 'id' => 'no_garajes', 'required' => 'required']) !!}
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-3 border-right">
                    <div class="form-group row">
                        ...
                        <div class="col-6">
                            {!! Form::select('n_hab', $num_hab, null, ['class' => 'form-select', 'id' => 'no_garajes', 'required' => 'required']) !!}
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-3 border-right">
                    <div class="form-group row">
                        ...
                        <div class="col-6">
                            {!! Form::select('no_banos', $num_banos, null, ['class' => 'form-select', 'id' => 'no_garajes', 'required' => 'required']) !!}
                        </div>
                    </div>
                </div>
